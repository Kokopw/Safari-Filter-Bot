...
from plugins.maintenance import initialize_maintenance_status
...
async def start():
    ...
    await initialize_maintenance_status()
    ...
    await SafariBot.send_message(chat_id=LOG_CHANNEL, text=script.RESTART_TXT.format(temp.B_NAME, today, time, temp.U_NAME, temp.B_NAME))
    await idle()
