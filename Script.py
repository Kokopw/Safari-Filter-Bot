...
<b><blockquote>Iᴍ Tʜᴇ Mᴏsᴛ Aᴅᴠᴀɴᴄᴇ Aɪ Pᴏᴡᴇʀᴇᴅ Bᴏᴛ.🥰
Jᴜꜱᴛ Sᴇɴᴅ Mᴇ Aɴʏ Mᴏᴠɪᴇꜱ & Sᴇʀɪᴇꜱ Nᴀᴍᴇ Aɴᴅ Sᴇᴇ Mʏ Pᴏᴡᴇʀ.</b></blockquote>

<b>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - <a href=https://t.me/CharlieWatson1>ᴄʜᴀʀʟɪᴇ ʙʀᴏ</b></a>"""
...
ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ, ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ🔋</u>
...
🌟 Rating: <a href={url}/ratings>{rating}</a> / 10</b> """
    ...
    MAINTENANCE_MSG = """🔧✨ ʙᴏᴛ ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ɪɴ ᴘʀᴏɢʀᴇꜱꜱ...

🛠️ ᴘʟᴇᴀꜱᴇ ʙᴇ ᴘᴀᴛɪᴇɴᴛ ᴡʜɪʟᴇ ᴡᴇ ᴡᴏʀᴋ ᴏɴ ꜱᴏᴍᴇ ᴜᴘᴅᴀᴛᴇꜱ.

⏳ ʙᴏᴛ ᴡɪʟʟ ʙᴇ ʙᴀᴄᴋ ꜱᴏᴏɴ ᴡɪᴛʜ ʙᴇᴛᴛᴇʀ ᴘᴇʀꜰᴏʀᴍᴀɴᴄᴇ.

🙏 ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ʏᴏᴜʀ ᴘᴀᴛɪᴇɴᴄᴇ ᴀɴᴅ ᴜɴᴅᴇʀꜱᴛᴀɴᴅɪɴɢ."""

    CHANNELS = """<b>ᴊᴏɪɴ ᴛʜɪs ᴄʜᴀɴɴᴇʟ ғᴏʀ ʀᴇᴘᴏ ᴜᴘᴅᴀᴛᴇꜱ </b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=https://t.me/CharlieWatson1>ᴄʜᴀʀʟɪᴇ</a>"""
...
• /cleardb - <code>ᴄᴏᴍᴘʟᴇᴛᴇʟʏ ʀᴇsᴇᴛ ʙᴏᴛʜ ᴅᴀᴛᴀʙᴀsᴇs.</code>
...
<b>Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ Successfully ✅</b>

📅 Dᴀᴛᴇ : <code>{}</code>
⏰ Tɪᴍᴇ : <code>{}</code>
🌍 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Kolkata</code>

🙋‍♀️ My Name : <b><a href=https://t.me/{}>{}</a></b>"""
...
🙏 ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ʏᴏᴜʀ ᴘᴀᴛɪᴇɴᴄᴇ ᴀɴᴅ ᴜɴᴅᴇʀꜱᴛᴀɴᴅɪɴɢ."""
    ...
    DELETE_PERMISSION_MSG = """⚠️ <b>Permission Required</b>

Hello! To work properly in this group, I need the <b>Delete Messages</b> permission.

Please grant me this permission so I can manage search messages and keep the chat clean.
Without it, some of my features may not work as expected. 🙏"""

    ADMIN_PERMISSION_MSG = """⚠️ <b>Admin Permission Required</b>

Hello! I need admin privileges to perform this action. 

Please make me an admin in this chat so I can manage messages and perform important tasks.
